!function ($) {
    ...
    $(function () {
        $('body').on('click.jcarousel.data-api', '[data-jslide]', function (e) {
            var $this = $(this), id,
                $target = $($this.attr('data-target') || (id = $this.attr('data-id')) && id.replace(/.*(?=#[^\s]+$)/, '')),
        ...
        $('[data-start-jcarousel]').each(function () {
            ...
            $this.bind('jslide', function (e) {
                ...
                $('[data-jslide]').each(function () {
                    var $nav = $(this), $navData = $nav.data(), id, $target = $($nav.attr('data-target') || (id = $nav.attr('data-id')) && id.replace(/.*(?=#[^\s]+$)/, ''));
